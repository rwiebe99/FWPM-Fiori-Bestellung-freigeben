		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#acceptpurchaseorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"acceptpurchaseorder-display": {
								"semanticObject": "acceptpurchaseorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acceptpurchaseorder",
									"url": sap.ui.require.toUrl("acceptpurchaseorder")
								}
							}
						}
					}
